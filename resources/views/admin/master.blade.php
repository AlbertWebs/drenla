...
<body class="padTop53 " >
    ...
    <!--END MAIN WRAPPER -->
     ...
     <!-- FOOTER -->
     <div id="footer">
        <p>&copy;  <a title="Nekta CMS is an Open Source Content management System intended for websites and web based applications" href="http://www.designekta.com">Designekta Studios</a> &nbsp;<?php $time=date('Y'); echo $time; ?> &nbsp; <a href="https://designekta.com">Contact Support</a></p>
    </div>
    <!--END FOOTER -->
