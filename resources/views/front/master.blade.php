...
<head>
  ...
  {{-- @favicon --}}
  <link rel="apple-touch-icon" sizes="60x60" href="{{asset('theme/favicons/apple-touch-icon.png')}}">
  <link rel="icon" type="image/png" sizes="32x32" href="{{asset('theme/favicons/favicon-32x32.png')}}">
  <link rel="icon" type="image/png" sizes="16x16" href="{{asset('theme/favicons/favicon-16x16.png')}}">
  <link rel="manifest" href="favicons/site.html">
  <link rel="mask-icon" href="favicons/safari-pinned-tab.svg" color="#5bbad5">
  <meta name="msapplication-TileColor" content="#f9aa28">
  <meta name="theme-color" content="#ffffff">

  <!-- CSS-->
  <link rel="stylesheet" href="{{asset('theme/css/bootstrap-grid.css')}}">
  <link rel="stylesheet" href="{{asset('theme/css/main.css')}}">
  <title>Interior Design and Architectural Visualization | Drenla Hub</title>
</head>
  ...
  <div class="animsition">
      ...
      <nav class="mobile-canvas__nav navigation">
        <ul class="navigation__list">
          <li class="navigation__item navigation__item--current">
            <a class="navigation__link" href="index-2.html">Home</a>
                ...
                <div class="navigation__dropdown-column">
                  ...
                  <ul class="navigation__dropdown-list">
                    <li class="navigation__dropdown-item">
                      <a class="animsition-link" href="index-2.html">Home Default</a>
                    </li>
                    <li class="navigation__dropdown-item">
    ...
    <footer class="footer footer--lite footer--white">
      <div class="footer__inner container">
        <div class="row">
          <div class="col-6">
            <div class="footer__copy">© Larson 2021.</div>
          </div>
