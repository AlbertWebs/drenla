    ...
    <div class="projects-grid">
      <div class="projects-grid__inner container">
        <ul class="projects-grid__list row">
          ...
          <li class="projects-grid__item col-md-6 col-lg-4 col-xl-3">
            <a class="card card--transparent __js_home-grid-card" href="projects-detail.html" data-bg="{{asset('theme/img/picture/home-grid/4.jpg')}}">
              <div class="card__content">
                <div class="card__tag">Exterior</div>
                <h3 class="card__heading">Redesign Exterior</h3>
                <div class="card__text">Founded in 2007, Sparch is specializing in providing innovative services such as websitFounded in 2007</div>
              </div>
            </a>
          </li>
          ...
          <li class="projects-grid__item col-md-6 col-lg-4 col-xl-3">
            <a class="card card--transparent __js_home-grid-card" href="projects-detail.html" data-bg="{{asset('theme/img/picture/home-grid/7.jpg')}}">
              <div class="card__content">
                <div class="card__tag">Interior</div>
                <h3 class="card__heading">IBM Office</h3>
                <div class="card__text">Founded in 2007, Sparch is specializing in providing innovative services such as websitFounded in 2007</div>
              </div>
            </a>
          </li>
          <li class="projects-grid__item col-md-6 col-lg-4 col-xl-3">
            <a class="card card--transparent __js_home-grid-card" href="projects-detail.html" data-bg="{{asset('theme/img/picture/home-grid/8.jpg')}}">
              <div class="card__content">
                <div class="card__tag">Architecture</div>
                <h3 class="card__heading">Architecture</h3>
                <div class="card__text">Founded in 2007, Sparch is specializing in providing innovative services such as websitFounded in 2007</div>
              </div>
            </a>
          </li>
          ...
          <li class="projects-grid__item col-md-6 col-lg-4 col-xl-3">
            <a class="card card--transparent __js_home-grid-card" href="projects-detail.html" data-bg="{{asset('theme/img/picture/home-grid/12.jpg')}}">
              <div class="card__content">
                <div class="card__tag">Residental</div>
                <h3 class="card__heading">Recntagle House</h3>
                <div class="card__text">Founded in 2007, Sparch is specializing in providing innovative services such as websitFounded in 2007</div>
              </div>
            </a>
          </li>
